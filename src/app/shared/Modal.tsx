      ...
      <Dialog as="div" className="relative z-20" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-20 overflow-y-auto font-atkinson">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className={`relative transform overflow-hidden bg-gray-100 border border-gray-200 text-left shadow-lg transition-all sm:my-8 w-[327px] sm:w-[450px] rounded-lg`}
              >
                {children}
              </Dialog.Panel>
            </Transition.Child>
